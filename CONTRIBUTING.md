# Contributing to Bitcore-Artax

We're working hard to make *bitcore-artax* the most powerful JavaScript library for working with Artax. Our goal is to have *bitcore-artax* be a library that can be used by anyone interested in Artax, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-artax to which any change should adhere.
